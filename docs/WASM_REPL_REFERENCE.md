...
| Builtins (browser-safe) | Supported     | 237 of 457, derived from `builtin/metadata.go` rather than hand-listed (section 5) |
...
The full standard library is **457 builtins across 34 categories** — see the
