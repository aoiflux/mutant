...
| Builtins (browser-safe) | Supported     | 220 of 440, derived from `builtin/metadata.go` rather than hand-listed (section 5) |
...
The full standard library is **440 builtins across 34 categories** — see the
