...
| Builtins (browser-safe) | Supported     | 220 of 430, derived from `builtin/metadata.go` rather than hand-listed (section 5) |
...
The full standard library is **430 builtins across 33 categories** — see the
