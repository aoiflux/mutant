...
A programming language and toolchain for security and forensic work. 604
builtins across 39 categories — filesystem and disk-image parsers, registry and
...
- **[Cookbook](COOKBOOK.md)** — fourteen complete programs, organised by
  investigation
- **[Capability Reference](CAPABILITY_REFERENCE.md)** — all 604 builtins with
